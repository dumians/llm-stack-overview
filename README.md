...
In transformers, hallucinations seems to be cascading as hallucinated tokens lead to more
hallucinated tokens because the coherence enforced by the attention mechanism.
...
Although OpenAI has been able to significantly reduce hallucination in GPT-3.5 and GPT-4
models, it is considered to be a major (and still not completely understood) problem in
LLM technology in 2023.
